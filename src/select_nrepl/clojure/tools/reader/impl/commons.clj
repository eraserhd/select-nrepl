...
(ns select-nrepl.clojure.tools.reader.impl.commons
  (:refer-clojure :exclude [char])
  (:require [select-nrepl.clojure.tools.reader.reader-types :refer [peek-char read-char]]
            [select-nrepl.clojure.tools.reader.impl.errors :refer [reader-error]]
            [select-nrepl.clojure.tools.reader.impl.utils :refer [numeric? newline? char]])
