...
(ns ^{:doc "An EDN reader in clojure"
      :author "Bronsa"}
  select-nrepl.clojure.tools.reader.edn
  ...
  (:require [select-nrepl.clojure.tools.reader.reader-types :refer
            ...
            [select-nrepl.clojure.tools.reader.impl.utils :refer
            ...
            [select-nrepl.clojure.tools.reader :refer [default-data-readers]])
...
(defn read
  "Reads the first object from an IPushbackReader or a java.io.PushbackReader.
   ...
   select-nrepl.clojure.tools.reader.edn/read doesn't depend on dynamic Vars, all configuration
...
(defn read-string
  "Reads one object from the string s.
   ...
   opts is a map as per select-nrepl.clojure.tools.reader.edn/read"
