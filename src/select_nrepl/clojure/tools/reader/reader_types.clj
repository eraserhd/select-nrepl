...
(ns ^{:doc "Protocols and default Reader types implementation"
      :author "Bronsa"}
    select-nrepl.clojure.tools.reader.reader-types
  (:refer-clojure :exclude [char read-line])
  (:require [select-nrepl.clojure.tools.reader.impl.utils :refer [char whitespace? newline? make-var]])
...
(extend-protocol ReaderCoercer
  ...
  select_nrepl.clojure.tools.reader.reader_types.Reader
  (to-rdr [rdr] rdr)
  String
...
(extend-protocol PushbackReaderCoercer
  ...
  select_nrepl.clojure.tools.reader.reader_types.PushbackReader
  (to-pbr [rdr buf-len] (push-back-reader rdr buf-len))
  String
...
(defn indexing-reader?
  ...
  [rdr]
  (or (instance? select_nrepl.clojure.tools.reader.reader_types.IndexingReader rdr)
      (instance? LineNumberingPushbackReader rdr)
      (and (not (instance? select_nrepl.clojure.tools.reader.reader_types.PushbackReader rdr))
           (not (instance? select_nrepl.clojure.tools.reader.reader_types.StringReader rdr))
           (not (instance? select_nrepl.clojure.tools.reader.reader_types.InputStreamReader rdr))
