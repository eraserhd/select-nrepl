(ns ^:no-doc select-nrepl.rewrite-clj.node.coerce
  (:require [select-nrepl.rewrite-clj.potemkin :refer [defprotocol+]]
            [select-nrepl.rewrite-clj.node
             ...
             [whitespace :as ws]])
  (:import [select_nrepl.rewrite_clj.node.comment CommentNode]
           [select_nrepl.rewrite_clj.node.forms FormsNode]
           [select_nrepl.rewrite_clj.node.integer IntNode]
           [select_nrepl.rewrite_clj.node.keyword KeywordNode]
           [select_nrepl.rewrite_clj.node.meta MetaNode]
           [select_nrepl.rewrite_clj.node.quote QuoteNode]
           [select_nrepl.rewrite_clj.node.reader_macro
            ReaderNode ReaderMacroNode DerefNode]
           [select_nrepl.rewrite_clj.node.seq SeqNode]
           [select_nrepl.rewrite_clj.node.string StringNode]
           [select_nrepl.rewrite_clj.node.token TokenNode]
           [select_nrepl.rewrite_clj.node.uneval UnevalNode]
           [select_nrepl.rewrite_clj.node.whitespace WhitespaceNode NewlineNode]))
